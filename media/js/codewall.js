...
(function(){
    var appendCoderwallBadge = function(){
        var coderwallJSONurl ="http://www.coderwall.com/willddy.json?callback=?"
          , size = 32
          ;
        ...
        $.getJSON(coderwallJSONurl, function(data) {
            $.each(data.data.badges, function(i, item){
                var a = $("<a>")
                    .attr("href", "http://www.coderwall.com/willddy/")
                    .attr("target", "_blank")
                    ;
...
//                    .click( function(){ window.location = "http://www.coderwall.com/willddy/"; })
                    .appendTo(a)
                    ;
                $("#coderwall").append(a);
            });
